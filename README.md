...
- **🌍 Access Anywhere** - Upload files from any device and download them from anywhere
- **🔐 Secure Storage** - Password-protected accounts keep your files safe
- **⚡ Fast & Efficient** - Built on MongoDB GridFS for optimal performance
- **🎨 Beautiful UI** - Enjoy a stunning neon-themed, cyberpunk-inspired interface
...
3. **Configure environment variables**
   ...
   Create `.env` files:
   - `backend/.env` → Set `MONGODB_URI` and `PORT`
...
| Feature | Description |
|---------|-------------|
| **🎯 Quick Upload** | Drag files directly onto the interface or click to browse |
| **📊 Storage Tracking** | Visual progress bar showing used vs. available space |
| **🔍 Instant Search** | Type to filter files in real-time |
| **⚙️ Settings Panel** | Manage account and change password |
| **🌙 Neon Effects** | Glowing borders, smooth transitions, cyberpunk aesthetics |
